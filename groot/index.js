...
module.exports.elk_rev1 = function(esClient, state, driver_data, operation_parameters, result_callback) {
  var timeout = state.timeout;
  if(operation_parameters.timeout && util.is_integer(operation_parameters.timeout) && operation_parameters.timeout > 0) {
    timeout = operation_parameters.timeout;
  }
...
// This is a artificial dashboard where the highlight clause have been removed from the search panel query.
module.exports.elk_rev2 = function(esClient, state, driver_data, operation_parameters, result_callback) {
  var timeout = state.timeout;
  if(operation_parameters.timeout && util.is_integer(operation_parameters.timeout) && operation_parameters.timeout > 0) {
    timeout = operation_parameters.timeout;
  }
